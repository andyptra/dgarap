			...
			<div id="wrapper">
				...
				<!-- Main -->
					...
					<?php
						...
						$tampil=mysql_query("SELECT post.*,cat_post.nama,user.dp FROM post,cat_post,user WHERE post.id_kategori=cat_post.id AND post.penulis=user.username and cat_post.id='$_GET[id_kategori]' order by post.id DESC LIMIT $posisi, $batas");
