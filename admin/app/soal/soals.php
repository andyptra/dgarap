...
<script type="text/javascript" src="app/soal/soal.js"></script>
...
<div class="row">
    ...
    <form method="post" name="cform" id="cform">
        <input type="hidden" name="id_ujian" value="<?php echo $_POST['d'];?>"/>
    	<div id="txtEditorContent6" class="form-group">
                    <label>Isikan Soal di bawah ini  </label>
    <textarea name="txtEditorContent6" style="width:100%"></textarea><br />
        
                    </div><!-- /.input group -->
                  
        <div id="txtEditorContent5" class="form-group">
                    <label>Jawaban A  </label>
      				<textarea name="txtEditorContent5"></textarea>
                   ...
                   <div id="txtEditorContent4" class="form-group">
                    ...
                    <div class="form-group">
      						  <textarea name="txtEditorContent4"></textarea>
                  ...
                  <div id="txtEditorContent3" class="form-group">
                    ...
                    <div class="form-group">
      						  <textarea name="txtEditorContent3"></textarea>
                  ...
                  <div id="txtEditorContent2" class="form-group">
                    ...
                    <div class="form-group">
      						  <textarea name="txtEditorContent2"></textarea>
                   ...
                   <div id="txtEditorContent1" class="form-group">
                    ...
                    <div class="form-group">
      						  <textarea name="txtEditorContent1"></textarea>
...
<div id="simple-msg"></div>
		...
		<input type="submit" class="btn btn-success" value="Simpan Soal"></button>
